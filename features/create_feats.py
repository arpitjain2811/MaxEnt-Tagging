...
for i in range(0, len(words)):
    ...
    for j in range(i - back_window_size, i):
        if j < 0:
            if prev_tag:
                feature = feature + "prev" + str(idx_back) + "word" + "=" + default_word + " " + "prev" + str(
                    idx_back) + "pos" + "=" + default_pos + " " + "prev" + str(
                    idx_back) + "tag" + "=" + default_pos + " "
            ...
            if prev_tag:
                feature = feature + "prev" + str(idx_back) + "word" + "=" + words[j] + " " + "prev" + str(
                    idx_back) + "pos" + "=" + poss[j] + " " + "prev" + str(idx_back) + "tag" + "=" + tags[j] + " "
    ...
    for j in range(i + 1, i + 1 + forward_window_size):
        if j >= len(words):
            feature = feature + "next" + str(idx_forward) + "word" + "=" + default_word + " " + "next" + str(
                idx_forward) + "pos" + "=" + default_pos + " "
        else:
            feature = feature + "next" + str(idx_forward) + "word" + "=" + words[j] + " " + "next" + str(
                idx_forward) + "pos" + "=" + poss[j] + " "
